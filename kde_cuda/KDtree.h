...
public:
    ...
    //void Search(const Point &query, int *ret_index, float *ret_sq_dist); // nearest neighbor search
    void SearchRange(const Point &query, float range, vector<int> &ret_index, vector<float> &ret_sq_dist); // range search
